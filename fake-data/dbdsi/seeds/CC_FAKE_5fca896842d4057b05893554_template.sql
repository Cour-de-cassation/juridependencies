INSERT INTO ${DBDSI_TABLE_JURINET} (ID_DOCUMENT, CLEF_ARRET, TYPE_ARRET, NATURE_JURISPRUDENCE, JURIDICTION, ID_CHAMBRE, COMPOSITION, NUM_DECISION, DT_DECISION, ID_SOLUTION, TEXTE_VISE, RAPROCHEMENT, PRESIDENT, CONSRAP, AVOG, SOURCE, DOCTRINE, CAT_PUB, IND_CORRIGEJO, IND_VALIDEJO, TYPE_LIEN, XML, DT_CREATION, AUT_CREATION, DT_MODIF, AUT_MODIF, IND_BICC, LIEN_BICC, IND_RCC, LIEN_RCC, IND_WWW, LIEN_WWW, SOURCEBIS, DT_ANO, IND_ANO, XMLA, AUT_ANO, DT_ENVOI_DILA, DT_MODIF_ANO, XMLT, XMLAT, IND_VERIF_ARRET, IND_VERIF_RAPPORT, IND_VERIF_AVIS, AUT_ANO_RAPPORT, DT_ANO_RAPPORT, AUT_ANO_AVIS, DT_ANO_AVIS, COM_PRESSE, NOTE_EXPL, REF_ARRET_CEDH, LIEN_ARRET_CEDH, IND_PM, IND_PHYM_GEOM, IND_ADRESSE, IND_DT_NAISSANCE, IND_DT_DECE, IND_DT_MARIAGE, IND_IMMATRICULATION, IND_CADASTRE, IND_CHAINE, IND_COORDONNEE_ELECTRONIQUE, IND_PRENOM_PROFESSIONEL, IND_NOM_PROFESSIONEL, OCCULTATION_SUPPLEMENTAIRE, ID_FORMATION, IND_BULLETIN, IND_RAPPORT, IND_LETTRE, IND_COMMUNIQUE) VALUES (
		1679433,
		0,
		'CC',
		NULL,
		...
		NULL,
		'51801129',
		TO_DATE('2018-07-11 00:00:00', 'YYYY-MM-DD HH24:MI:SS'),
		'Cassation',
		'article 1134 du code civil, dans sa rédaction applicable à la cause ;
article L. 1233-3 du code du travail, dans sa rédaction applicable à la cause.',
		'Sur le principe que le seul refus par le salarié d''une modification de son contrat de travail ne constitue pas une cause réelle et sérieuse de licenciement, à rapprocher : 
Soc., 28 janvier 2005, pourvoi n° 03-40.639, Bull. 2005, V, n° 35 (cassation partielle) ;
Soc., 7 juin 2005, pourvoi n° 03-42.080, Bull. 2005, V, n° 189 (cassation sans renvoi), et les arrêts cités.
Sur le principe que la rupture résultant du refus par le salarié d''une modification de son contrat de travail, proposée par l''employeur pour un motif non inhérent à sa personne, constitue un licenciement pour motif économique, dans le même sens que :
Soc., 11 décembre 2001, pourvoi n° 99-42.906, Bull. 2001, V, n° 376 (1) (rejet), et l''arrêt cité.',
		'M. Lannister (conseiller doyen faisant office de président)',
		NULL,
		'M. Stark',
		'Bull. 2018, V, n° 140.',
		...
		1,
		NULL,
		(TO_CLOB('<?xml version="1.0" encoding="ISO-8859-1" ?><DOCUMENT><ID_DOCUMENT>2004848</ID_DOCUMENT><CLEF_ARRET></CLEF_ARRET><TYPE_ARRET></TYPE_ARRET><NATURE_JURISPRUDENCE></NATURE_JURISPRUDENCE><JURIDICTION>Cour de cassation</JURIDICTION><CHAMBRE>CR</CHAMBRE><COMPOSITION></COMPOSITION><NUM_DECISION>C2401295</NUM_DECISION><DT_DECISION>23/10/2024</DT_DECISION><SOLUTION>Rejet</SOLUTION><TEXTE_VISE></TEXTE_VISE><RAPPROCHEMENT></RAPPROCHEMENT><PRESIDENT>M. Lannister</PRESIDENT><CONSRAP>Mme Leprieur</CONSRAP><AVOG>M. Stark</AVOG><SOURCE></SOURCE><DOCTRINE></DOCTRINE><CAT_PUB>P</CAT_PUB><IND_BICC>0</IND_BICC><LIEN_BICC></LIEN_BICC><IND_RCC>0</IND_RCC><LIEN_RCC></LIEN_RCC><IND_WWW>0</IND_WWW><LIEN_WWW></LIEN_WWW><TEXTE_ARRET>[DECISION FACTICE]N° H 23-86.670 F-B
 ...
 ARRÊT D') || TO_CLOB('E LA COUR DE CASSATION, CHAMBRE CRIMINELLE, 
 DU 23 OCTOBRE 2024
 
 
 
 *DEBAR M. Philippe Dominique a formé un pourvoi contre l''arrêt de la chambre de l''instruction de la cour d''appel de Rennes, en date du 20 octobre 2023, qui l''a déclaré pénalement irresponsable des faits de violences et rébellion, aggravées, a prononcé sur une admission en soins psychiatriques sous la forme d''une hospitalisation complète ainsi que sur des mesures de sûreté. *FINAR 
 
 *DEBUT Un mémoire a été produit.
 
 Sur le rapport de Mme Leprieur, conseiller, les observations de la SCP Boucard-Maman, avocat de M. Philippe Dominique, et les conclusions de M. Stark, avocat général, après débats en l''audience publique du 25 septembre 2024 où étaient présents M. Lannister, président, Mme Leprieur, conseiller rapporteur, M. de Larosière de Champfeu, conseiller de la chambre, et Mme Sommier, greffier de chambre,
 
 la chambre criminelle de la Cour de cassation, composée en application de l''article 567-1-1 du c') || TO_CLOB('ode de procédure pénale, des président et conseillers précités, après en avoir délibéré conformément à la loi, a rendu le présent arrêt.*FIN 
 
 *DEBDAR Faits et procédure
 ...
 5. Par ordonnance du 17 juillet 2023, le juge d''instruction a retenu qu''il existait à son encontre, d''une part, des charges suffisantes et, d''autre part, des raisons plausibles de considérer qu''il') || TO_CLOB(' était atteint, au moment des faits, d''un trouble psychique ou neuro-psychique ayant aboli son discernement ou le contrôle de ses actes. Il a ordonné la transmission de la procédure au procureur général pour saisine de la chambre de l''instruction.
...
4°) interdiction de détenir une arme pour une durée de dix ans, alors :
 ...
 13. En statuant ainsi, la') || TO_CLOB(' chambre de l''instruction n''a méconnu aucun des textes visés au moyen pour les motifs qui suivent.
 ...
 Ainsi fait et jugé par la Cour de cassation, chambre criminelle, et prononcé par le président en son audience publique du vingt-trois octobre deux mille vingt-quatre.
</TEXTE_ARRET><DT_CREATION>23/10/2024</DT_CREATION><AUT_CREATION>INFO</AUT_CREATION><DT_MODIF>23/10/2024</DT_MODIF><AUT_MODIF>LO</AUT_MODIF><ANALYSES><ANALYSE id="1"><TITRE_PRINCIPAL>RESPONSABILITE PENALE*</TITRE_PRINCIPAL') || TO_CLOB('><PREMIER_MAILLON>RESPONSABILITE PENALE*</PREMIER_MAILLON><SOMMAIRE> </SOMMAIRE><TITRE_REFERENCE></TITRE_REFERENCE></ANALYSE></ANALYSES><NUMPOURVOIS><NUMPOURVOI id="1">H2386670</NUMPOURVOI></NUMPOURVOIS><DECATTS><DECATT id="1"><JUR_DECATT>Chambre de l''instruction de la cour d''appel de Rennes</JUR_DECATT><DT_DECATT>20/10/2023</DT_DECATT></DECATT></DECATTS><PARTIES></PARTIES><AVOCATS><AVOCAT id="1">SCP Boucard-Maman</AVOCAT></AVOCATS></DOCUMENT>')),
		TO_DATE('2018-07-13 15:18:10', 'YYYY-MM-DD HH24:MI:SS'),
		'INFO',
		NULL,
		NULL,
		1,
		...
		NULL,
		NULL,
		TO_DATE('2021-10-04 07:44:32', 'YYYY-MM-DD HH24:MI:SS'),
		TO_DATE('2018-07-16 09:16:01', 'YYYY-MM-DD HH24:MI:SS'),
		NULL,
		NULL,
		0,
		0,
