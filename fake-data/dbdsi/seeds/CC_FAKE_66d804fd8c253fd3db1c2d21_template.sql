INSERT INTO ${DBDSI_TABLE_JURINET} (ID_DOCUMENT, CLEF_ARRET, TYPE_ARRET, NATURE_JURISPRUDENCE, JURIDICTION, ID_CHAMBRE, COMPOSITION, NUM_DECISION, DT_DECISION, ID_SOLUTION, TEXTE_VISE, RAPROCHEMENT, PRESIDENT, CONSRAP, AVOG, SOURCE, DOCTRINE, CAT_PUB, IND_CORRIGEJO, IND_VALIDEJO, TYPE_LIEN, XML, DT_CREATION, AUT_CREATION, DT_MODIF, AUT_MODIF, IND_BICC, LIEN_BICC, IND_RCC, LIEN_RCC, IND_WWW, LIEN_WWW, SOURCEBIS, DT_ANO, IND_ANO, XMLA, AUT_ANO, DT_ENVOI_DILA, DT_MODIF_ANO, XMLT, XMLAT, IND_VERIF_ARRET, IND_VERIF_RAPPORT, IND_VERIF_AVIS, AUT_ANO_RAPPORT, DT_ANO_RAPPORT, AUT_ANO_AVIS, DT_ANO_AVIS, COM_PRESSE, NOTE_EXPL, REF_ARRET_CEDH, LIEN_ARRET_CEDH, IND_PM, IND_PHYM_GEOM, IND_ADRESSE, IND_DT_NAISSANCE, IND_DT_DECE, IND_DT_MARIAGE, IND_IMMATRICULATION, IND_CADASTRE, IND_CHAINE, IND_COORDONNEE_ELECTRONIQUE, IND_PRENOM_PROFESSIONEL, IND_NOM_PROFESSIONEL, OCCULTATION_SUPPLEMENTAIRE, ID_FORMATION, IND_BULLETIN, IND_RAPPORT, IND_LETTRE, IND_COMMUNIQUE) VALUES (
		...
		NULL,
		'12400442',
		TO_DATE('2024-09-04 00:00:00', 'YYYY-MM-DD HH24:MI:SS'),
		'Rectification d''erreur matérielle  (pas fin d''instance)',
		NULL,
		NULL,
...
4°) interdiction de détenir une arme pour une durée de dix ans, alors :
 ...
 Ainsi fait et jugé par la Cour de cassation, chambre criminelle, et prononcé par le président en son audience publique du vingt-trois octobre deux mille vingt-quatre.
		...
		TO_DATE('2024-09-04 08:49:13', 'YYYY-MM-DD HH24:MI:SS'),
		'INFO',
		NULL,
		NULL,
		NULL,
		...
		NULL,
		NULL,
		TO_DATE('2024-09-09 14:03:02', 'YYYY-MM-DD HH24:MI:SS'),
		TO_DATE('2024-09-08 17:32:11', 'YYYY-MM-DD HH24:MI:SS'),
		NULL,
		NULL,
		0,
		0,
