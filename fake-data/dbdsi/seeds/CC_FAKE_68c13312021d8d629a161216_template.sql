...
article 31, § 2, de la Charte des droits fondamentaux de l''Union européenne.',
		'Soc., 2 juin 2021, pourvoi n° 20-12.961 (cassation partielle), et les arrêts cités.',
...
4°) interdiction de détenir une arme pour une durée de dix ans, alors :
 ...
 Ainsi fait et jugé par la Cour de cassation, chambre criminelle, et prononcé par le président en son audience publique du vingt-trois octobre deux mille vingt-quatre.
		...
		TO_DATE('2025-09-10 10:10:22', 'YYYY-MM-DD HH24:MI:SS'),
		'INFO',
		NULL,
		NULL,
		0,
		...
		NULL,
		NULL,
		TO_DATE('2025-11-03 07:17:48', 'YYYY-MM-DD HH24:MI:SS'),
		TO_DATE('2025-09-10 15:16:31', 'YYYY-MM-DD HH24:MI:SS'),
		NULL,
		NULL,
		0,
		0,
